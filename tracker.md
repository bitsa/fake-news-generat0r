...
| openai-transform | Real OpenAI call in transform worker (with dev mock kill-switch) | 1 | in_dev | [spec](docs/openai-transform-spec.md) | [dev](docs/openai-transform-dev.md) | — | — |
