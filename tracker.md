...
| chat-stream-skeleton | Chat — POST streaming endpoint (mock LLM, real SSE) | 1 | in_dev | [spec](docs/chat-stream-skeleton/chat-stream-skeleton-spec.md) | [dev](docs/chat-stream-skeleton/chat-stream-skeleton-dev.md) | — | — |
| chat-llm | Chat — real OpenAI streaming (replaces mock generator + adds prompt builder) | 1 | spec'd | [spec](docs/chat-llm/chat-llm-spec.md) | — | — | Depends on chat-stream-skeleton — see OQ-3. |
