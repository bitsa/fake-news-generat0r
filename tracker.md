...
| get-articles | GET /api/articles Feed Endpoint | 1 | in_qa | [get-articles-spec.md](docs/get-articles-spec.md) | [dev](docs/get-articles-dev.md) | [qa](docs/get-articles-qa.md) | — |
...
| openai-transform | Real OpenAI call in transform worker (with dev mock kill-switch) | 1 | spec'd | [spec](docs/openai-transform-spec.md) | — | — | — |
