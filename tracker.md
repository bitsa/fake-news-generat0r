...
| chat-llm | Chat — real OpenAI streaming (replaces mock generator + adds prompt builder) | 1 | in_qa | [spec](docs/chat-llm/chat-llm-spec.md) | [dev](docs/chat-llm/chat-llm-dev.md) | — | Depends on chat-stream-skeleton — see OQ-3. |
